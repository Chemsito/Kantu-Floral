...
- Un pago rechazado o cancelado puede reintentarse con Mercado Pago. El webhook oficial sigue siendo la fuente de verdad del estado y un pago ya aprobado no puede reemplazarse por otro `payment_id`.
